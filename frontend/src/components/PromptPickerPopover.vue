...
<style scoped>
.prompt-picker-layer { position:fixed; inset:0; z-index:1000; display:grid; place-items:center; padding:22px; background:var(--prompt-snow-overlay); }
.prompt-picker-dialog { width:min(760px,100%); max-height:min(720px,calc(100vh - 44px)); overflow:auto; padding:26px; background:var(--prompt-snow-surface); border:1px solid var(--prompt-snow-border-strong); box-shadow:var(--prompt-snow-shadow); color:var(--prompt-snow-text); }
.prompt-picker-heading { display:flex; justify-content:space-between; align-items:flex-start; padding-bottom:17px; border-bottom:1px solid var(--prompt-snow-border); }.prompt-picker-heading span { display:flex; align-items:center; gap:7px; color:var(--prompt-snow-accent); font-size:12px; }.prompt-picker-heading h2 { margin:6px 0 0; font-size:24px; }
.prompt-picker-toolbar { display:flex; gap:10px; margin:18px 0; }.prompt-picker-search { display:flex; align-items:center; gap:8px; flex:1; min-height:40px; padding:0 11px; border:1px solid var(--prompt-snow-border); background:var(--prompt-snow-surface-muted); }.prompt-picker-search input { flex:1; border:0; outline:0; background:transparent; color:inherit; }.prompt-picker-toolbar select { min-width:130px; border:1px solid var(--prompt-snow-border); background:var(--prompt-snow-surface-muted); color:var(--prompt-snow-text); padding:9px 11px; }
.prompt-picker-list { display:grid; gap:9px; }.prompt-picker-entry { display:flex; align-items:center; justify-content:space-between; gap:16px; padding:14px; border:1px solid var(--prompt-snow-border); background:var(--prompt-snow-surface-muted); }.prompt-picker-entry-copy { min-width:0; }.prompt-picker-entry-copy h3 { display:inline; margin:0 0 0 8px; font-size:16px; }.prompt-picker-category { color:var(--prompt-snow-accent); font-size:12px; }.prompt-picker-entry-copy p { margin:8px 0 0; color:var(--prompt-snow-text-muted); line-height:1.5; white-space:pre-wrap; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; overflow:hidden; }.prompt-picker-entry .primary-action { flex:none; background:var(--prompt-snow-accent); border-color:var(--prompt-snow-accent); }.prompt-picker-empty { min-height:210px; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:9px; color:var(--prompt-snow-text-muted); }.prompt-picker-empty strong { color:var(--prompt-snow-text); }.prompt-picker-footer { display:flex; align-items:center; justify-content:space-between; gap:12px; margin-top:18px; padding-top:15px; border-top:1px solid var(--prompt-snow-border); color:var(--prompt-snow-text-muted); font-size:12px; }
